import { booleanValidator, numberValidator, stringValidator, minNumberValidator, maxNumberValidator, dateValidator, maxDateValidator, minDateValidator } from "validators"
...
describe("validators", () => {
  it("booleanValidator", async () => {
    ...
    expect(booleanValidator(new Date(), {})).toStrictEqual("invalid_type_boolean")
  })
  ...
  it("numberValidator", () => {
    ...
    expect(numberValidator(new Date(), {})).toStrictEqual("invalid_type_number")
  })
  ...
  it("stringValidator", () => {
    ...
    expect(stringValidator(new Date(), {})).toStrictEqual("invalid_type_string")
  })
  ...
  it("minDateValidator", () => {
    ...
    expect(validator(new Date("2000-01-01"), {})).toStrictEqual("invalid_value_min_date")
  })
  ...
  it("maxDateValidator", () => {
    ...
    expect(validator("test", {})).toStrictEqual(("invalid_type_date"))
    expect(validator(1, {})).toStrictEqual("invalid_type_date")
    expect(validator(new Date("2040-01-01"), {})).toStrictEqual("invalid_value_max_date")
  })
})
