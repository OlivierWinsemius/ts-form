...
class Form {
  constructor({ values, onSubmit, validators }) {
    ...
    this.reset = () => {
      ...
      this.touchedFields = (0, object_from_keys_1.objectFromKeys)(
        initialValues,
        () => false
      );
    ...
    this.validateField = (field) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        this.formErrors[field] = yield validators[field].validate(values);
        this.afterValidateField(field, this);
      });
    this.validateAllFields = () =>
      __awaiter(this, void 0, void 0, function* () {
        const { values, validators, fieldNames } = this;
        const validate = fieldNames.map((field) =>
          __awaiter(this, void 0, void 0, function* () {
            this.formErrors[field] = yield validators[field].validate(values);
          })
        );
    ...
    this.validators = (0, object_from_keys_1.objectFromKeys)(values, (key) => {
      ...
      (_a =
        validators === null || validators === void 0
          ? void 0
          : validators[key]) === null || _a === void 0
        ? void 0
        : _a.call(validators, validator);
      return validator;
    });
    this.validateAllFields();
  }
